package com.example.nobre.ntrack.helper;

import android.widget.ArrayAdapter;
import android.widget.EditText;
import android.widget.Spinner;

import com.example.nobre.ntrack.FormularioCadastroMotoActivity;
...
public class CadastroMotoHelper {
    ...
    public CadastroMotoHelper(FormularioCadastroMotoActivity activity) {
